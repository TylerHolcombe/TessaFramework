...
/**
 * Class defines default exception codes used by the Tessa Framework.
 *
 * Primarily, clients should rely on HttpStatus codes to determine the correct follow-up behavior.
 * Individual Tessa Exception Codes are meant for usage in debugging and communicating error information
 * rather than for clients to take action upon.
 *
 * Tessa Exception Code Ranges:
 * 		1xx -> Client TessaError
 * 		2xx -> Gateway Errors
 *		3xx -> Authentication/Authorization Errors
 * 		4xx -> Database TessaError
 * 		5xx -> External API TessaError
 * 		6xx -> Application TessaError
 */
public class TessaExceptionCodes
{
	...
	public static final String AUTH_FAILURE_MESSAGE = "Could not loadAndVerifySecurityDetails or authorize user.";
	...
	public static final long INSUFFICIENT_AUTHENTICATION_CODE = 320;
	public static final String INSUFFICIENT_AUTHENTICATION_MESSAGE = "The request was understood, but it has been refused.";
